...
if __name__ == "__main__":
    ...
    parser.add_argument('-pro', action="store", dest='pro', default="MOD03")
    ...
    downloadfile = f'/home/nvme/zhaolx/Download_MODIS/MODIS_3H/MOD03/MOD03_2006.txt'      # /{pro}_{year}.txt'
