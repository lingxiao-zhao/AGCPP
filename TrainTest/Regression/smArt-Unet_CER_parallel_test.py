...
def test(path):
    ...
    # **保存 preImg**
    save_path = f'/home/nvme/zhaolx/Unet_train/regression/savedata/{epochs}_{keys[productIndex]}.npy'
...
if __name__ == '__main__':
    ...
    parse.add_argument("-ckp", type=str, dest='ckp', help="the path of model weight file",
                        default="/home/nvme/zhaolx/Unet_train/regression/modelsave/cer300/weights_92_cer_ddp.pth")
