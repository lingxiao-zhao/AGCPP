...
def test(path):
    ...
    # default_device = torch.device("cpu")  # 先加载到 CPU，避免设备不匹配错误
    ...
    inputDatasets = Mydataset(path, imgpara=imgpara, augment=False)
...
if __name__ == '__main__':
    ...
    parse.add_argument("-ckp", type=str, dest='ckp', help="the path of model weight file",
                        default="/home/nvme/zhaolx/Unet_train/classification/modelsave/phase300-Class3Best/weights_102_phase_ddp.pth")# 继续计算的时候填入
